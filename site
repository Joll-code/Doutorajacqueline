...
<div id="reveal-screen">
  <div class="reveal-box">
    <div id="preStart">
      ...
      <p class="reveal-sub">SOMENTE PARA ADVOGADA JACQUELINE :P </p>
      <button class="start-btn" id="startBtn">TÁ COM OAB AI?</button>
    </div>

    <div class="loading-wrap" id="loadingWrap">
      <div class="reveal-icon">⏳</div>
      <h2 class="reveal-title" id="loadingTitle">CALMA QUE O TIO É LENTO</h2>
...
<div class="stage">
  <div class="card">
    ...
    <p class="message">
      ...
      Parabéns pela aprovação, minha DOUTORA. Cada madrugada
